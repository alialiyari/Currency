...
public class IdentityChannelClient
{

    public readonly GrpcChannel channel;
    private readonly IHttpContextAccessor httpContextAccessor;

    public IdentityChannelClient(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
    {
        this.httpContextAccessor = httpContextAccessor;
        channel = GrpcChannel.ForAddress(configuration["IdentityGrpcServiceUrl"]);
    }
