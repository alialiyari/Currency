...
public class SmsChannelClient
{

    public readonly GrpcChannel channel;
    private readonly IHttpContextAccessor httpContextAccessor;

    public SmsChannelClient(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
    {
        this.httpContextAccessor = httpContextAccessor;
        channel = GrpcChannel.ForAddress(configuration["SmsGrpcServiceUrl"]);
    }
